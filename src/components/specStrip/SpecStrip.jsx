...
export default function SpecStrip() {
  return (
    <div className="grid grid-cols-1 items-baseline gap-x-6 py-4 section-px border-y border-(--line) font-mono uppercase font-light tracking-[0.08em] text-[11px] text-(--dim)">
